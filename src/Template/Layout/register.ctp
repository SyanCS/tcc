...
<body class="hold-transition register-page" style="background:rgb(54,127,169)">
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <a href="<?php echo $this->Url->build(array('controller' => 'users', 'action' => 'login'));?>" class="text-center">I already have a membership</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
